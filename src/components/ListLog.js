...
//     this.state.project.methods.purchaseProduct(id,pname,price,purchasedateInUnixTimestamp).send({ from: this.state.account, value: price })
            ...
            { this.state.logdata.map((logdata1, key) => {
              return(
                ...
                <tr key={key}>
                  ...
                  <td>{format(parseInt(logdata1.logdate),'dd/MM/yyyy')}</td>
